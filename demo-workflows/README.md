...
| `ltx 2.3/LTX 2.3 Video I2V_T2V_ZAM.json` | LTX 2.3 video — I2V and T2V | Image-to-video and text-to-video with LTX 2.3 |
| `ltx 2.3/LTX 2.3 Video I2V_T2V_Quality.json` | LTX 2.3 video — quality variant | Higher quality LTX 2.3 video with adjusted settings |
...
└── ltx 2.3/
    ├── LTX 2.3 Video I2V_T2V_ZAM.json
    ├── LTX 2.3 Video I2V_T2V_Quality.json
